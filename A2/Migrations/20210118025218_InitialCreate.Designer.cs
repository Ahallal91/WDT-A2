...
namespace A2.Migrations
{
    ...
    [Migration("20210118025218_InitialCreate")]
            ...
            modelBuilder.Entity("A2.Models.Transaction", b =>
                {
                    ...
                    b.Property<int?>("DestAccountAccountNumber")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DestAccountAccountNumber");
            ...
            modelBuilder.Entity("A2.Models.Transaction", b =>
                {
                    ...
                    b.HasOne("A2.Models.Account", "DestAccount")
                        .WithMany()
                        .HasForeignKey("DestAccountAccountNumber");
